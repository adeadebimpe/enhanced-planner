					...
					{onSearch && (
						<div className="relative hidden md:block">
							...
							<input
								...
								className="h-9 w-48 lg:w-64 bg-card/50 border border-border pl-9 pr-3 text-sm focus:outline-none focus:ring-1 focus:ring-primary placeholder:text-muted-foreground/50"
							/>
						</div>
					)}
					{rightContent}
